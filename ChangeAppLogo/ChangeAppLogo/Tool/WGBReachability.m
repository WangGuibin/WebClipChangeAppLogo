...
#pragma unused (target)
    ...
    WGBReachability *reachability = ((__bridge WGBReachability*)info);
...
@implementation WGBReachability

#pragma mark - Class Constructor Methods

+(instancetype)reachabilityWithHostName:(NSString*)hostname
{
    return [WGBReachability reachabilityWithHostname:hostname];
}
...
+ (BOOL)judgeIsConnectionAvailable{
    ...
    WGBReachability *reach = [WGBReachability reachabilityWithHostName:@"http://www.baidu.com"];
